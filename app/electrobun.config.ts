...
const config: ElectrobunConfig = {
  ...
  build: {
    ...
    copy: {
      ...
      "../mcp/windows-mcp/build.ps1": "mcp/windows-mcp/build.ps1",
      "../mcp/windows-mcp/manifest.json": "mcp/windows-mcp/manifest.json",
      "../mcp/windows-mcp/lowcode.config.json": "mcp/windows-mcp/lowcode.config.json",
      "../mcp/yingdao-mcp/build.ps1": "mcp/yingdao-mcp/build.ps1",
      "../mcp/yingdao-mcp/manifest.json": "mcp/yingdao-mcp/manifest.json",
      "../mcp/wechat-mcp/build.ps1": "mcp/wechat-mcp/build.ps1",
      "../mcp/wechat-mcp/manifest.json": "mcp/wechat-mcp/manifest.json",
      "../mcp/crm-mcp/build.ps1": "mcp/crm-mcp/build.ps1",
      "../mcp/crm-mcp/manifest.json": "mcp/crm-mcp/manifest.json",
      "../mcp/crm-mcp/lowcode.config.json": "mcp/crm-mcp/lowcode.config.json",
      "../mcp/crm-mcp/src/index.ts": "mcp/crm-mcp/src/index.ts",
      "../mcp/crm-mcp/src/types.ts": "mcp/crm-mcp/src/types.ts",
      "../mcp/crm-mcp/src/crm.ts": "mcp/crm-mcp/src/crm.ts",
    },
