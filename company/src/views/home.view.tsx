    ...
    <section class="hero bg-base-100 rounded-box shadow-xl border border-base-300">
      <div class="hero-content py-14">
        <div class="max-w-3xl">
          ...
          <h1 class="text-4xl font-bold leading-tight">Client + Gateway · 在线 openclaw 集群管理平台</h1>
          <p class="py-4 text-base-content/80">设置 company URL 后，Client 自动接入公司 Gateway，统一管理所有设备动作。</p>
          <p class="text-base-content/80">支持创建无人公司、批量下发命令、重启网关、追踪执行结果与审计记录。</p>
