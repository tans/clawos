              ...
              <div id="carousel" class="flex transition-transform duration-500 ease-in-out h-full">
                ...
                <div class="w-full flex-shrink-0 flex flex-col p-6">
                  ...
                  <div class="mt-4 flex-grow flex items-center justify-center">
                    <img src="/public/delivery-ui.png" alt="交付形态" class="max-h-48 sm:max-h-56 rounded-2xl object-contain" />
                  </div>
                </div>
                {/* 部署方式卡片 */}
                <div class="w-full flex-shrink-0 flex flex-col p-6">
                  ...
                  <div class="mt-4 flex-grow flex items-center justify-center">
                    <img src="/public/deployment-ui.png" alt="部署方式" class="max-h-48 sm:max-h-56 rounded-2xl object-contain" />
                  </div>
                </div>
                {/* 适用团队卡片 */}
                <div class="w-full flex-shrink-0 flex flex-col p-6">
                  ...
                  <div class="mt-4 flex-grow flex items-center justify-center">
                    <img src="/public/team-ui.png" alt="适用团队" class="max-h-48 sm:max-h-56 rounded-2xl object-contain" />
                  </div>
                </div>
              </div>
              {/* 轮播指示器 */}
